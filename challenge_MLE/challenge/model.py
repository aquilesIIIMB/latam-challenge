...
class DelayModel:
    ...
    def preprocess(
        ...
        try:
            ...
            df_data['delay'] = np.where(df_data['min_diff'] > threshold_in_minutes, 1, 0)
            ...
            logger.info(f"Created {features.shape[1]} features through one-hot encoding")
    ...
    def fit(
        ...
        try:
            ...
            logger.info(f"Class 0 - Precision: {report['0']['precision']:.2f}, Recall: {report['0']['recall']:.2f}, F1: {report['0']['f1-score']:.2f}")
            logger.info(f"Class 1 - Precision: {report['1']['precision']:.2f}, Recall: {report['1']['recall']:.2f}, F1: {report['1']['f1-score']:.2f}")
    ...
    def predict(
        ...
        if self._model is None:
            ...
            try:
                ...
                raise RuntimeError("Model is not trained or cannot be loaded. Call `fit()` first.")
